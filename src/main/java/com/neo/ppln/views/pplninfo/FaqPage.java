...
@PageTitle("FAQ | PPLN Chicago")
@AnonymousAllowed

public class FaqPage extends ArticleView{

    public FaqPage(CrmService crmService, SecurityService securityService) {
        super(crmService, securityService, "FAQ");
    }
}
